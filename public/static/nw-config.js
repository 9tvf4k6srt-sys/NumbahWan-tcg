...
const NW_CONFIG = {
    ...
    pages: {
        ...
        museum: { path: '/museum', emoji: '🏛️', category: 'core',
        ...
        forge: { path: '/forge', emoji: '⚒️', category: 'game',
        ...
        arcade: { path: '/arcade', emoji: '🕹️', category: 'game',
        ...
        // Absurdist pages
        court: { path: '/court', emoji: '⚖️', category: 'absurdist',
