...
const SPEC_TYPES = {
  ...
  'landing-page': {
    name: 'Landing Page (Cinematic)',
    description: 'Cinematic landing page — hero hook (video/poster), 3–5 narrative beats, film layer, fallback ladder. Doctrine: references/LANDING-CINEMATIC.md',
    requiredFields: ['type', 'slug', 'title', 'theme', 'hero', 'cta'],
    optionalFields: ['beats', 'sections', 'testimonials', 'pricing', 'i18n', 'sound'],
    outputDir: 'public',
    template: 'landing',
    i18nDefault: true,
    cinematic: {
      playbook: 'references/LANDING-CINEMATIC.md',
      lint: 'tools/landing-lint.cjs',
      budgets: { heroVideoMB: 4, pageHtmlKB: 200, totalPageMB: 2 },
      beats: { min: 3, max: 5 },
      fallbackLadder: ['full', 'prefers-reduced-motion', 'low-gpu/data-saver', 'no-js'],
    },
  },
  'app-page': {
    name: 'App Page',
