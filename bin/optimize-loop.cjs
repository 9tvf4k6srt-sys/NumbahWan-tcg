...
function cmdApply(mem) {
  ...
  if (JSON_OUT) {
    console.log(JSON.stringify({ applied: added, backup }, null, 2));
  } else {
...
module.exports = { categoryStats, ruleCategory, scoreRule, specificity, proposeForCategory, CATEGORY_PLAYBOOK };
