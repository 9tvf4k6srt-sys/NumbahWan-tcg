...
const shrineState = {
  ...
  prayers: [
    { id: 1, text: 'Dear Bald One, please grace our guild with your presence. We\'ve been grinding for 3 weeks.', flames: 342, walletId: 'NW-SEED01', created_at: new Date(Date.now() - 3600000).toISOString() },
    { id: 2, text: 'My copium reserves are running low. We need you, Zack.', flames: 256, walletId: 'NW-SEED02', created_at: new Date(Date.now() - 7200000).toISOString() },
    { id: 3, text: 'I sacrificed 200 Sacred Logs for this. Please. PLEASE.', flames: 189, walletId: 'NW-SEED03', created_at: new Date(Date.now() - 14400000).toISOString() },
    { id: 4, text: 'McConnell told me this wouldn\'t work. Prove him wrong.', flames: 445, walletId: 'NW-SEED04', created_at: new Date(Date.now() - 21600000).toISOString() },
    { id: 5, text: 'If you come to MapleStory, I\'ll donate my entire transmog collection.', flames: 167, walletId: 'NW-SEED05', created_at: new Date(Date.now() - 28800000).toISOString() },
    { id: 6, text: 'The cockroach in my apartment said you\'d come. Don\'t make it a liar.', flames: 523, walletId: 'NW-SEED06', created_at: new Date(Date.now() - 43200000).toISOString() },
    { id: 7, text: 'Day 47 of summoning. The shrine is starting to crack. Or maybe that\'s just me.', flames: 298, walletId: 'NW-SEED07', created_at: new Date(Date.now() - 86400000).toISOString() },
    { id: 8, text: 'It is what it is. But it doesn\'t have to be.', flames: 712, walletId: 'NW-SEED08', created_at: new Date(Date.now() - 172800000).toISOString() }
  ],
  nextPrayerId: 9,
...
router.get('/count', (c) => {
  return c.json({
    ...
    milestone: shrineState.globalCount >= 1000000 ? '1M' : shrineState.globalCount >= 100000 ? '100K' : shrineState.globalCount >= 10000 ? '10K' : null,
    nextMilestone: shrineState.globalCount < 10000 ? 10000 : shrineState.globalCount < 100000 ? 100000 : shrineState.globalCount < 1000000 ? 1000000 : 10000000
  });
});
...
router.get('/leaderboard', (c) => {
  ...
  if (leaders.length < 5) {
    ...
    demoLeaders.forEach(d => { if (!existing.has(d.name)) leaders.push(d); });
