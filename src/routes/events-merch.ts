  ...
  const weeklyEvents = [
    {
      ...
      day: 1,
      emoji: '🏪',
      bonuses: { tradeBonus: 0.1, marketDiscount: 0.05 },
    },
    { id: 'training_tuesday', name: 'Training Tuesday', day: 2, emoji: '⚔️', bonuses: { xpMultiplier: 1.5 } },
    {
      ...
      day: 3,
      emoji: '🏆',
      bonuses: { battleRewards: 1.5, tournamentEntry: true },
    },
    {
      ...
      day: 4,
      emoji: '⏰',
      bonuses: { legacyCardsAvailable: true },
    },
    {
      id: 'forge_friday',
      name: 'Forge Friday',
      day: 5,
      emoji: '🔥',
      bonuses: { pityBonus: 0.5, mythicRateBoost: 2.0 },
    },
    {
      id: 'social_saturday',
      ...
      day: 6,
      emoji: '🤝',
      bonuses: { coopRewards: 2.0, guildBonus: 1.5 },
    },
...
router.post('/merch/claim', async (c) => {
  try {
    ...
    const { code, deviceUUID: _deviceUUID } = body
    ...
    const demoCodes: Record<string, any> = {
      'NWMR-TEST-BRNZ': {
        ...
        rewards: {
          cards: [{ name: 'Loyal Guardian', rarity: 'rare' }],
          gold: 100,
          logs: 0,
          discount: 0.05,
          title: 'Supporter',
      ...
      'NWMR-TEST-SLVR': {
        ...
        rewards: {
          cards: [{ name: 'Storm Caller', rarity: 'epic' }],
          gold: 250,
          logs: 50,
          discount: 0.1,
          title: 'Collector',
      ...
      'NWMR-TEST-GOLD': {
        ...
        rewards: {
          cards: [{ name: 'Golden Phoenix', rarity: 'legendary' }],
          gold: 1000,
          logs: 200,
          discount: 0.15,
          title: 'Elite Member',
      ...
      'NWMR-TEST-PLAT': {
        ...
        rewards: {
          cards: [{ name: 'Primordial Dragon', rarity: 'mythic' }],
          gold: 5000,
          logs: 500,
          discount: 0.2,
