...
export async function claimCard(cache: KVNamespace, claimCode: string, walletAddress: string): Promise<ClaimResult> {
...
export async function unstakeCard(
  ...
  const _totalYield = stake.totalEarned + pendingYield
